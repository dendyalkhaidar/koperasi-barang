    ...
    public function index(){
        ...
        if  ($this->form_validation->run()== false) {   
            ...
            $this->db->insert('user_menu',['menu'=>$this->input->post('menu')]);
               $this->session->set_flashdata('pesan','<div class="alert alert-success" role="alert">Menu Telah Ditambahkan</div>');
            redirect('menu');
        }
        ...
        $data['menu']=$this->db->get('user_menu')->result_array();
            ...
            $this->load->view('templates/footer');
                ...
                $this->db->insert('user_sub_menu',$data);
                 $this->session->set_flashdata('pesan','<div class="alert alert-success" role="alert">SubMenu Telah Ditambahkan</div>');
